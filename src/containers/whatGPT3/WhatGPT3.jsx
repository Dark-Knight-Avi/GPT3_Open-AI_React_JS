  ...
  return (
    <div className="gpt3__whatgpt3 section__margin" id="wgpt3">
      ...
      <div className="gpt3__whatgpt3-container">
        ...
        <Feature heading={"Knowledgebase"} para={"At jointure ladyship an insisted so humanity he. Friendly bachelor entrance to on by. As put impossible own apartments."}/>
        <Feature heading={"Education"} para={"At jointure ladyship an insisted so humanity he. Friendly bachelor entrance to on by. As put impossible own apartments."}/>
      </div>
    </div>
  );
};
